...
import cn.edu.food_blog.fragment.viewmodel.FoodBlogsViewModel
import cn.edu.food_blog.fragment.viewmodel.FoodBlogsViewModelFactory
...
class FoodBlogsFragment : Fragment() {
    ...
    private val vm by lazy {
        ViewModelProvider(activity!!, FoodBlogsViewModelFactory(activity!!))
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //注入recyclerview
        vm.foodPosterAdapter = FoodPosterAdapter(activity!!, vm.foodPosterList)
